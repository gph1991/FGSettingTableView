#
#  Be sure to run `pod spec lint FGSettingTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "GeeFarm" => "guopenghao@haogw.com" }
  # Or just: s.author    = "GeeFarm"
  # s.authors            = { "GeeFarm" => "guopenghao@haogw.com" }
  # s.social_media_url   = "http://twitter.com/GeeFarm"
  ...
  s.source       = { :git => "http://EXAMPLE/FGSettingTableView.git", :tag => "#{s.version}" }
